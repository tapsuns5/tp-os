...
const ModernLayout: React.FC = () => {
  ...
  const sidebarBaseClasses =
    "border-r border-zinc-800 flex flex-col bg-[#111111] transition-all duration-300 ease-in-out overflow-hidden";
...
const NavItem = ({ icon, label, isActive, onClick, expanded }: any) => (
  ...
  >
    ...
    <span
      className={`font-semibold tracking-tight transition-opacity duration-300 ${expanded ? "opacity-100" : "opacity-0"}`}
    >
      {label}
    </span>
  </button>
                ...
                scheemeIndex === 0 ? (
                          ...
                          .map((miamiPart, miamiIndex) =>
                            miamiIndex === 0 ? (
                              ...
                              <React.Fragment key={miamiIndex}>
                                <img
                                  src="/Miami_Hurricanes_logo.svg"
                                  alt="Miami Hurricanes"
                                  className="inline-block w-5 h-5 mx-1 align-middle"
                                />
                                {miamiPart
                                  .split("[MIAMI_HEAT_LOGO]")
                                  .map((heatPart, heatIndex) =>
                                    heatIndex === 0 ? (
                                      heatPart
                                        .split("\n")
                                        .map((line, lineIndex) => (
                                      ...
                                      <React.Fragment key={heatIndex}>
                                        <img
                                          src="/miami-heat-logo-vice-symbol.png"
                                          alt="Miami Heat"
                                          className="inline-block w-5 h-5 mx-1 align-middle"
                                        />
                                        {heatPart
                                          .split("[MIAMI_DOLPHINS_LOGO]")
                                          .map((dolphinsPart, dolphinsIndex) =>
                                            dolphinsIndex === 0 ? (
                                              dolphinsPart
                                                .split("\n")
                                                .map((line, lineIndex) => (
                                              ...
                                              >
                                                <img
                                                  src="/miami_dolphins_1997-2002.png"
                                                  alt="Miami Dolphins"
                                                  className="inline-block w-5 h-5 mx-1 align-middle"
                                                />
                                                {dolphinsPart
                                                  .split(
                                                    "[FLORIDA_PANTHERS_LOGO]",
                                                  )
                                                  .map(
                                                    (
                                                      panthersPart,
                                                      ...
                                                      panthersIndex === 0 ? (
                                                        ...
                                                        >
                                                          <img
                                                            src="/Florida_Panthers_2016_logo.svg"
                                                            alt="Florida Panthers"
                                                            className="inline-block w-5 h-5 mx-1 align-middle"
                                                          />
                                                          {panthersPart
                                                            .split(
                                                              "[FLORIDA_MARLINS_LOGO]",
                                                            )
                                                            .map(
                                                              (
                                                                marlinsPart,
                  ...
                  <React.Fragment key={scheemeIndex}>
                    <img
                      ...
                      onClick={() =>
                        window.open("https://tryscheeme.com", "_blank")
                      }
                    />
                    {scheemePart.split("[X_ICON]").map((xPart, xIndex) =>
                      xIndex === 0 ? (
      ...
      <div className="flex justify-between items-end mb-12">
        <div>
          ...
          <p className="text-zinc-500 text-sm mt-1">
            I mostly write about my experiences in product design and
            engineering.
          </p>
        </div>
        <button
          onClick={onViewAll}
          className="text-sm font-bold text-zinc-400 hover:text-white transition-colors border-b border-transparent hover:border-white pb-1"
        >
          View all
        </button>
      </div>
...
const PostCard = ({ title, date, tags, onClick }: any) => {
  ...
  return (
    <div
      className="group flex flex-col md:flex-row md:items-center justify-between p-6 rounded-md border border-zinc-800/50 hover:border-zinc-700 bg-zinc-900/20 hover:bg-zinc-900/40 transition-all cursor-pointer"
      onClick={onClick}
    >
      <div className="mb-4 md:mb-0">
        ...
        <h4 className="text-lg text-white font-bold group-hover:text-blue-400 transition-colors leading-snug">
          {title}
        </h4>
      </div>
  ...
  return (
    <div className="animate-in slide-in-from-bottom-8 duration-700">
      <header className="mb-16">
        <h2 className="text-4xl text-white font-bold mb-4 tracking-tight">
          Writing
        </h2>
        <p className="text-zinc-500 text-lg">
          My thoughts on design, engineering, and everything in between.
        </p>
      </header>
        ...
        {loadingBlogs ? (
          ...
          blogPosts.map((post) => (
            <article
              ...
              onClick={() => onPostSelect(post.id)}
            >
              <p className="text-xs font-bold text-zinc-600 mb-3 uppercase tracking-widest font-mono">
                {post.date}
              </p>
              <h3 className="text-2xl text-white font-bold group-hover:text-blue-400 transition-colors mb-4">
                {post.title}
              </h3>
...
const WorkView = () => (
  <div className="animate-in slide-in-from-bottom-8 duration-700">
    <header className="mb-16">
      ...
      <p className="text-zinc-500 text-lg">
        Companies I have worked for and things I have done
      </p>
    </header>
...
const ProjectCard = ({
  ...
  return (
    ...
    >
      ...
      <h3 className="text-2xl text-white font-bold mb-3 group-hover:text-blue-400 transition-colors tracking-tight">
        {title}
      </h3>
      ...
      <div className="flex justify-between items-center mt-auto">
        <div className="flex flex-wrap gap-2">
          {stack.map((s: string) => (
            <span
              key={s}
              className="text-[10px] bg-zinc-800 px-3 py-1 rounded-md text-zinc-300 font-bold uppercase tracking-widest"
            >
              {s}
            </span>
          ))}
